...
export const translations: Record<Language, TranslationDict> = {
  EN: {
    ...
    farmerTitle: 'My Produce & Harvest Batches',
    ...
    activeHarvestLots: 'My Produce Lots',
  ...
  MR: {
    ...
    farmerTitle: 'माझा शेतमाल व पीक नोंदी',
